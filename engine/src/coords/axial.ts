...
export function neighborOf(hex: AxialHex, edge: EdgeId): AxialHex {
  return {
...
export function areNeighbors(a: AxialHex, b: AxialHex): boolean {
  return hexDistance(a, b) === 1;
}

export function edgeBetween(from: AxialHex, to: AxialHex): EdgeId | null {
...
export function areMutualNeighbors(a: AxialHex, b: AxialHex): boolean {
